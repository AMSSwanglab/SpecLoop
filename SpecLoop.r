...
left_anchor_data <- read.csv("./data/Example_left_anchor_data.csv",header = T,row.names = 1)
right_anchor_data <- read.csv("./data/Example_right_anchor_data.csv",header = T,row.names = 1)
label <- read.csv("./data/Example_label.csv",header = T,row.names = 1)
ppi <- read.csv("./data/TF_PPI.csv",header = F)
cross_tissue_expression <- read.csv("./data/TF_cross_tissue_expression.csv",header = T,row.names = 1)
TF_expression <- read.csv("./data/TF_gene_expression.csv",header = T,row.names = 1)
Label <- label$Label
